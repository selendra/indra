...
pub struct BuildAuraConsensusParams<PF, BI, RBackend, CIDP, Client, BS, SO> {
	...
	pub block_import: BI,
	pub relay_chain_client: selendra_client::Client,
...
/// a concrete relay chain client instance, the builder takes a [`selendra_client::Client`]
/// that wraps this concrete instance. By using [`selendra_client::ExecuteWithClient`]
...
struct AuraConsensusBuilder<P, Block, PF, BI, RBackend, CIDP, Client, SO, BS, Error> {
	...
	block_import: BI,
	relay_chain_backend: Arc<RBackend>,
	relay_chain_client: selendra_client::Client,
	para_client: Arc<Client>,
	backoff_authoring_blocks: Option<BS>,
	sync_oracle: SO,
	force_authoring: bool,
...
impl<Block, PF, BI, RBackend, CIDP, Client, SO, BS, P, Error> selendra_client::ExecuteWithClient
	...
	P::Signature: TryFrom<Vec<u8>> + Hash + Member + Encode + Decode,
{
	...
	where
		...
		Api: selendra_client::RuntimeApiCollection<StateBackend = PBackend::State>,
		PClient: selendra_client::AbstractClient<PBlock, PBackend, Api = Api> + 'static,
	{
