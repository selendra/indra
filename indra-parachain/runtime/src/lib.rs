...
// Selendra imports
use pallet_xcm::{Config, EnsureXcm, IsMajorityOfBody, XcmPassthrough};
use selendra_parachain::primitives::Sibling;
use selendra_runtime_common::{BlockHashCount, RocksDbWeight, SlowAdjustingFeeUpdate};
...
pub type Precompiles = precompiles::SelendraPrecompiles<Runtime>;
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("indra"),
	impl_name: create_runtime_str!("indra-parachain"),
	authoring_version: 1,
	spec_version: 1,
	impl_version: 0,
...
parameter_types! {
		/// Selendra `TransactionByteFee` / 2
		pub const TransactionByteFee: Balance = 250 * NANO;
...
pub type XcmRouter = (
	...
	cumulus_primitives_utility::ParentAsUmp<ParachainSystem, SelendraXcm>,
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		SelendraXcm: pallet_xcm::{Pallet, Call, Storage, Event<T>, Origin} = 31,
		...
		// Evm
		EthCall: pallet_custom_signatures::{Pallet, Call, Event<T>, ValidateUnsigned} = 42,
		Evm: pallet_evm::{Pallet, Config, Call, Storage, Event<T>} = 55,
		Ethereum: pallet_ethereum::{Pallet, Call, Storage, Event, Config, Origin} = 56,
		BaseFee: pallet_base_fee::{Pallet, Call, Storage, Config<T>, Event} = 57,
