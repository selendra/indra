use crate::{
	constants::precompiles::IndracorePrecompiles, AccountId, Aura, Balance, Balances, Call, Event,
...
pub type Precompiles = IndracorePrecompiles<Runtime>;
...
parameter_types! {
	...
	pub PrecompilesValue: Precompiles = IndracorePrecompiles::<_>::new();
}
