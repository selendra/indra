...
/// The PrecompileSet installed in the indracore runtime.
#[derive(Debug, Clone, Copy)]
pub struct IndracorePrecompiles<R>(PhantomData<R>);

impl<R> IndracorePrecompiles<R> {
	#[allow(dead_code)]
	pub fn new() -> Self {
	...
	R::Call: Dispatchable<PostInfo = PostDispatchInfo> + GetDispatchInfo + Decode,
{
	fn execute(
		...
		match address {
			...
			// indracore precompiles (starts from 0x5000):
			// Default
			_ => None,
		}
	}
